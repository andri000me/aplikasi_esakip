...
<div class="form">
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_misi', $opts2, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Misi--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#SasaranEselonTiga_id_instansi").val()', 'NoMisi' => 'js: $(this).val()'),
            'success' => 'function(data){$("#SasaranEselonTiga_nomor_tujuan").html(data);$("#SasaranEselonTiga_nomor_indikator").html("<option value=\'\'>--Pilih Indikator--</option>");}'
        ))); ?>
...
/*    $criteria = new CDbCriteria();
    ...
    'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#SasaranEselonTiga_id_instansi").val()', 'NoMisi' => 'js: $("#SasaranEselonTiga_nomor_misi").val()', 'NoTujuan' => 'js: $(this).val()'),
            'success' => 'function(data){$("#SasaranEselonTiga_nomor_sasaran_eselon_dua").html(data);}'
        ))); ?>
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_indikator', $opts3, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Indikator Tujuan--',
    'ajax' => array(
        'type' => 'POST', //request type
        'url' => CController::createUrl('loaddata/loadsasaraneselondua'),
        'data' => array('OPD' => 'js: $("#SasaranEselonTiga_id_instansi").val()', 'NoMisi' => 'js: $("#SasaranEselonTiga_nomor_misi").val()', 'NoTujuan' => 'js: $("#SasaranEselonTiga_nomor_tujuan").val()', 'NoIndikatorTujuan' => 'js: $(this).val()'),
        'success' => 'function(data){$("#SasaranEselonTiga_nomor_sasaran_eselon_dua").html(data);}'
    )
    )); ?>
...
<?php
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_sasaran_eselon_dua', $opts3, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Sasaran Eselon Dua--',
    'ajax' => array(
        'type' => 'POST', //request type
        'url' => CController::createUrl('loaddata/loadjabataneselontiga'),
        'data' => array('OPD' => 'js: $("#SasaranEselonTiga_id_instansi").val()', 'NoMisi' => 'js: $("#SasaranEselonTiga_nomor_misi").val()', 'NoTujuan' => 'js: $("#SasaranEselonTiga_nomor_tujuan").val()', 'NoIndikatorTujuan' => 'js: $(this).val()'),
        'success' => 'function(data){$("#SasaranEselonTiga_idpejabat").html(data);}'
    )
    )); ?>
...
<?php
    ...
    // $criteria->params = array(':idx' => Yii::app()->user->getOpd(), ':idz' => $model->idpejabat);
    $criteria->params = array(':idx' => Yii::app()->user->getOpd());
    $opts3 = CHtml::listData(Pejabat::model()->findAll($criteria), 'id', 'fullName');
    echo $form->dropDownListControlGroup($model, 'idpejabat', $opts3, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Jabatan--')); ?>
...
function loadData(){
        ...
        ajax({
            url:"<?php CController::createUrl('loaddata/loadsasaraneselondua') ?>",
            data: "<?php array('OPD' => 'js: $("#SasaranEselonTiga_id_instansi").val()', 'NoMisi' => 'js: $("#SasaranEselonTiga_nomor_misi").val()', 'NoTujuan' => 'js: $(this).val()') ?>", 
             success:function(data)  
             {  
                $("#SasaranEselonTiga_idsasaran").html(data); 
             }
        })
    }
