...
<?php
        ...
        header("Content-Disposition: attachment; filename=".$filename."_".$instansi["nama_instansi"].".xls");
        ...
        <div class="container-fluid">
            ...
            <div class="spacer-xs">
                ...
                <div class="page-title">
                    <h3 align="center">LAPORAN CASCADING</h3>
                    <h3 align="center"><?php echo strtoupper($instansi["nama_instansi"]);?></h3>
                    <h3 align="center">TAHUN <?php echo Yii::app()->user->getTahun(); ?></h3>
                    </h3>
                </div>
                
                <h3 align="center">VISI</h3>
                <p align="center">"<?php echo $visi["visi"];?>"</p>
