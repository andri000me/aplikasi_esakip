...
'<p> format file pohon kinerja yang diizinkan (.jpg, .png, .pdf, .doc, .docx, .xlsx, .xls)</p>'); ?>

<div class="form">

    <?php $form = $this->beginWidget('\TbActiveForm', array(
        'id' => 'upload-pohon-kinerja-form',
    ...
    <?php echo $form->fileFieldControlGroup($model, 'file_pk', array('rows' => 6, 'span' => 8)); ?>
