...
$no=1;
      ...
      foreach($misi as $misi_row){
           ...
           if(@$programeselontiga->idpejabat != ""){
    ...
    //       $indikatorprogrameselontiga = IndikatorProgramEselonTiga::model()->find(array("condition"=>"id_instansi='".$id_instansi."' and nomor_misi='".$misi_row->nomisi."' and nomor_tujuan='".$tujuan->nomor_tujuan."' and nomor_sasaran='".$sasaran->nomor_sasaran."' and indikator_sasaran='".$indikator->nomor_indikator."'  and nomor_indikator_eselon_dua='".$indikator->nomor_indikator."' and nomor_program_eselon_dua='".$program->nomor_program."' and nomor_program='".$programeselontiga->nomor_program."'"));

    //       $pejabateselontiga = Pejabat::model()->find(array("condition"=>"id_instansi='".$id_instansi."' and id='".$programeselontiga->idpejabat."' "));

    //       $pejabateselonempat = Pejabat::model()->find(array("condition"=>"id_instansi='".$id_instansi."' and parent_id='".$programeselontiga->idpejabat."' and id='".$indikatorprogrameselontiga->idpejabat_eselon_empat."' "));

    //       $data[] = array("key"=>$misi_row["misid"].$misi_row["nomisi"].$misi_row["idinstansi"].$tujuan->nomor_tujuan.$sasaran->nomor_sasaran.$indikator->nomor_indikator.$program->nomor_program.$programeselontiga->nomor_program.$indikatorprogrameselontiga->nomor_indikator,"boss"=>$misi_row["misid"].$misi_row["nomisi"].$misi_row["idinstansi"].$tujuan->nomor_tujuan.$sasaran->nomor_sasaran.$indikator->nomor_indikator.$programeselontiga->nomor_program.$indikatorprogrameselontiga->nomor_indikator,"name"=> $pejabateselonempat->nama_jabatan." \n Indikator Program Eselon 3 ".$no.": \n".$indikatorprogrameselontiga->indikator);
...
<div class="top-bar clearfix">
    ...
    <div class="pull-right" id="mini-nav-right">
        ...
        <a href="<?php echo Yii::app()->baseUrl; ?>/laporan/simpanfilepohonkinerja" class="btn btn-success btn-xs" rel="tooltip"
           data-original-title="Data Sasaran Eselon 4">
            Simpan Pohon Kinerja
        </a>

        <a href="<?php echo Yii::app()->baseUrl; ?>/laporan/indexPohonKinerja" class="btn btn-info btn-xs" rel="tooltip"
           data-original-title="Data Sasaran Eselon 4">
            Upload File Pohon Kinerja 
        </a>
    </div>
</div>
