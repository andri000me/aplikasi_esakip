...
<div class="top-bar clearfix">
    ...
    <div class="pull-right" id="mini-nav-right">
        <a href="<?php echo Yii::app()->baseUrl; ?>/listpk/create" class="btn btn-info btn-xs" rel="tooltip"
    ...
    <div class="spacer-xs">
        ...
        $coul = array(
            ...
            array(
                ...
                'name' => 'data_file_pk',
                'type' => 'raw',
                'value' => 'CHtml::link($data->data_file_pk,
                        Yii::app()->createUrl("static/datapk/$data->data_file_pk"),
                        array("target"=>"_blank") )',
            ),
