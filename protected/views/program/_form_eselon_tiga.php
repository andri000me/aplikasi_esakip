...
<div class="form">
        ...
        echo $form->dropDownListControlGroup($model, 'id_instansi', $opts,
            array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih OPD--',
                'ajax' => array(
                    ...
                    'success' => 'function(data){$("#ProgramEselonTiga_nomor_misi").html(data);$("#ProgramEselonTiga_nomor_tujuan").html("<option value=\'\'>--Pilih Tujuan--</option>");$("#ProgramEselonTiga_nomor_sasaran").html("<option value=\'\'>--Pilih Sasaran--</option>");$("#ProgramEselonTiga_nomor_indikator").html("<option value=\'\'>--Pilih Indikator--</option>");}'
                )
            ));
    } else {
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_misi', $opts2, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Misi--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#ProgramEselonTiga_id_instansi").val()', 'NoMisi' => 'js: $(this).val()'),
            'success' => 'function(data){$("#ProgramEselonTiga_nomor_tujuan").html(data);$("#ProgramEselonTiga_nomor_sasaran").html("<option value=\'\'>--Pilih Sasaran--</option>");$("#ProgramEselonTiga_nomor_indikator").html("<option value=\'\'>--Pilih Indikator--</option>");}'
        ))); ?>
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_tujuan', $opts3, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Tujuan--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#ProgramEselonTiga_id_instansi").val()', 'NoMisi' => 'js: $("#ProgramEselonTiga_nomor_misi").val()', 'NoTujuan' => 'js: $(this).val()'),
            'success' => 'function(data){$("#ProgramEselonTiga_nomor_sasaran").html(data);$("#ProgramEselonTiga_nomor_indikator").html("<option value=\'\'>--Pilih Indikator--</option>");}'
        ))); ?>
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_sasaran', $opts4, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Sasaran--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#ProgramEselonTiga_id_instansi").val()', 'NoMisi' => 'js: $("#ProgramEselonTiga_nomor_misi").val()', 'NoTujuan' => 'js: $("#ProgramEselonTiga_nomor_tujuan").val()', 'NoSasaran' => 'js: $(this).val()'),
            'success' => 'function(data){$("#ProgramEselonTiga_nomor_indikator").html(data);}'
        ))); ?>
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_indikator', $opts4, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Indikator--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#ProgramEselonTiga_id_instansi").val()', 'NoMisi' => 'js: $("#ProgramEselonTiga_nomor_misi").val()', 'NoTujuan' => 'js: $("#ProgramEselonTiga_nomor_tujuan").val()', 'NoSasaran' => 'js: $(this).val()'),
            'success' => 'function(data){$("#ProgramEselonTiga_idpejabat").html(data);}'
        ))); ?>
    
    <?php
    $criteria = new CDbCriteria();
    $criteria->addCondition("id_instansi=:idx");
    $criteria->addCondition("id=:idy");
    $criteria->params = array(':idx' => Yii::app()->user->getOpd(), ':idy' => $model->idpejabat);
    $opts4 = CHtml::listData(Pejabat::model()->findAll($criteria), 'id', 'fullName');
    echo $form->dropDownListControlGroup($model, 'idpejabat', $opts4, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Pejabat--')); ?>
