...
<div class="form">
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_program', $opts6, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Program--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#Indikatorkegiatan_id_instansi").val()', 'NoMisi' => 'js: $("#Indikatorkegiatan_nomor_misi").val()', 'NoTujuan' => 'js: $("#Indikatorkegiatan_nomor_tujuan").val()', 'NoSasaran' => 'js: $("#Indikatorkegiatan_nomor_sasaran").val()', 'NoIndikator' => 'js: $("#Indikatorkegiatan_nomor_indikator").val()', 'NoProgram' => 'js: $(this).val()'),
