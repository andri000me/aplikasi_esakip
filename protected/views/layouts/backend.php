...
<aside id="sidebar">
    ...
    $arrDash = array("home", "visi", "misi", "tujuan","indikatortujuan");
    $arrData = array("sasaran", "indikator", "program", "kegiatan", "aktivitas", "rencanaaksi", "renja", "renstra","indikatorprogram","indikatorkegiatan","dataiku","ikuopd");
        ...
        <ul>
            ...
            <li class='has-sub <?php echo in_array($ctrlName, $arrData) ? "active highlight" : "" ?>'>
                ...
                <ul <?php echo in_array($ctrlName, $arrData) ? "style='display: block'" : "" ?>>
                    ...
                    <li>
                        <a href='<?php echo Yii::app()->baseUrl; ?>/ikuopd' <?php echo $ctrlName === "ikuopd" ? "class='select'" : "" ?>>
                            <span>I.K.U</span>
                        </a>
                    </li>
                    <li>
            ...
            <li class='has-sub  <?php echo in_array($ctrlName, $arrLap) ? "active highlight" : "" ?>'>
                ...
                <ul <?php echo in_array($ctrlName, $arrLap) ? "style='display: block'" : "" ?>>
                    ...
                    <li>
                        <a href="<?php echo Yii::app()->baseUrl; ?>/laporan/cascading" <?php echo $ctrlName === "laporan/cascading" ? "class='select'" : "" ?>><span>Laporan Cascading</span></a>
                    </li>
                    <li>
                        <a href="<?php echo Yii::app()->baseUrl; ?>/laporan/pohonkinerja" <?php echo $ctrlName === "laporan/pohonkinerja" ? "class='select'" : "" ?>><span>Laporan Pohon Kinerja</span></a>
                    </li>
                </ul>
            </li>
            ...
            <ul id="mini-nav" class="clearfix">
                <li class="list-box">
                    <a id="drop1" href="#" role="button" class="dropdown-toggle current-user" data-toggle="dropdown">
                        <?php echo Yii::app()->user->getName() ?>|<?php echo Yii::app()->user->getNamaOpd() ?> <b class="caret"></b>
                    </a>
