...
<div class="top-bar clearfix">
    <div class="page-title">
        <h4>
            ...
            Data Indikator Sasaran Eselon 4
        </h4>
    </div>
    <div class="pull-right" id="mini-nav-right">
        ...
        <a href="<?php echo Yii::app()->baseUrl; ?>/indikator/eselonTiga" class="btn btn-info btn-xs" rel="tooltip"
           data-original-title="Data Indikator Sasaran Eselon 3">
            Eselon 3
        </a>

        <a href="<?php echo Yii::app()->baseUrl; ?>/indikator/eselonEmpat" class="btn btn-warning btn-xs" rel="tooltip"
           data-original-title="Data Indikator Sasaran Eselon 3">
            Eselon 4
        </a>
        
        <a href="<?php echo Yii::app()->baseUrl; ?>/indikator/createEselonEmpat" class="btn btn-info btn-xs" rel="tooltip"
           data-original-title="Tambah Data Indikator Sasaran Eselon 4">
