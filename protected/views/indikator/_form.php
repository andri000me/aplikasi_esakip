...
<div class="form">
        ...
        echo $form->dropDownListControlGroup($model, 'id_instansi', $opts,
            array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih OPD--',
                'ajax' => array(
                    ...
                    'success' => 'function(data){$("#Indikator_nomor_misi").html(data);$("#Indikator_nomor_tujuan").html("<option value=\'\'>--Pilih Tujuan--</option>");$("#Indikator_nomor_sasaran").html("<option value=\'\'>--Pilih Sasaran--</option>");}'
                )
            ));
    } else {
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_misi', $opts2, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Misi--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#Indikator_id_instansi").val()', 'NoMisi' => 'js: $(this).val()'),
            'success' => 'function(data){$("#Indikator_nomor_tujuan").html(data);$("#Indikator_nomor_sasaran").html("<option value=\'\'>--Pilih Sasaran--</option>");}'
        ))); ?>
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_tujuan', $opts3, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Tujuan--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#Indikator_id_instansi").val()', 'NoMisi' => 'js: $("#Indikator_nomor_misi").val()', 'NoTujuan' => 'js: $(this).val()'),
            'success' => 'function(data){$("#Indikator_nomor_sasaran").html(data);}'
        ))); ?>
