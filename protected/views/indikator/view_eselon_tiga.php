...
$this->menu = array(
    ...
    array('label' => 'Update Indikator', 'url' => array('updateEselonTiga', 'id' => $model->indikatorid)),
    array('label' => 'Hapus Indikator', 'url' => '#', 'linkOptions' => array('submit' => array('deleteEselonTiga', 'id' => $model->indikatorid), 'confirm' => 'Anda yakin menghapus data ini ?')),
);
?>
