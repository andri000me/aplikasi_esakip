...
<div class="form">
        ...
        echo $form->dropDownListControlGroup($model, 'id_instansi', $opts,
            array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih OPD--',
                'ajax' => array(
                    ...
                    'success' => 'function(data){$("#IndikatorEselonEmpat_nomor_misi").html(data);$("#IndikatorEselonEmpat_nomor_tujuan").html("<option value=\'\'>--Pilih Tujuan--</option>");$("#IndikatorEselonEmpat_nomor_sasaran").html("<option value=\'\'>--Pilih Sasaran--</option>");}'
                )
            ));
    } else {
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_misi', $opts2, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Misi--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#IndikatorEselonEmpat_id_instansi").val()', 'NoMisi' => 'js: $(this).val()'),
            'success' => 'function(data){$("#IndikatorEselonEmpat_nomor_tujuan").html(data);$("#IndikatorEselonEmpat_nomor_sasaran").html("<option value=\'\'>--Pilih Sasaran--</option>");}'
        ))); ?>
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_tujuan', $opts3, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Tujuan--',
        'ajax' => array(
            'type' => 'POST', //request type
            'url' => CController::createUrl('loaddata/loadsasaraneselonempat'),
            'data' => array('OPD' => 'js: $("#IndikatorEselonEmpat_id_instansi").val()', 'NoMisi' => 'js: $("#IndikatorEselonEmpat_nomor_misi").val()', 'NoTujuan' => 'js: $(this).val()'),
            'success' => 'function(data){$("#IndikatorEselonEmpat_nomor_sasaran_eselon_empat").html(data);}'
        ))); ?>
    ...
    $criteria->addCondition("nomor_sasaran=:idz");
    $criteria->addCondition("idpejabat_eselon_empat=:idp");
    $criteria->params = array(':idx' => Yii::app()->user->getOpd(), ':idm' => $model->nomor_misi, ':idy' => $model->nomor_tujuan, ':idz' => $model->nomor_sasaran_eselon_empat, ':idp' => $model->idpejabat_eselon_empat);
    $opts3 = CHtml::listData(SasaranEselonEmpat::model()->findAll($criteria), 'nomor_sasaran', 'fullName');
    echo $form->dropDownListControlGroup($model, 'nomor_sasaran_eselon_empat', $opts3, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Tujuan--',
        'ajax' => array(
            'type' => 'POST', //request type
            'url' => CController::createUrl('loaddata/loadjabataneselontiga'),
            'data' => array('OPD' => 'js: $("#IndikatorEselonEmpat_id_instansi").val()', 'NoMisi' => 'js: $("#IndikatorEselonEmpat_nomor_misi").val()', 'NoTujuan' => 'js: $("#IndikatorEselonEmpat_nomor_tujuan").val()', 'idpejabat_eselon_empat' => 'js: $(this).val()'),
            'success' => 'function(data){$("#IndikatorEselonEmpat_idpejabat_eselon_tiga").html(data);}'
        ))); ?>
    ...
    echo $form->dropDownListControlGroup($model, 'idpejabat_eselon_tiga', $opts3, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Tujuan--',
        'ajax' => array(
            'type' => 'POST', //request type
            'url' => CController::createUrl('loaddata/loadjabataneselonempat'),
            'data' => array('OPD' => 'js: $("#IndikatorEselonEmpat_id_instansi").val()', 'NoMisi' => 'js: $("#IndikatorEselonEmpat_nomor_misi").val()', 'NoTujuan' => 'js: $("#IndikatorEselonEmpat_nomor_tujuan").val()', 'idpejabat_eselon_tiga' => 'js: $(this).val()'),
            'success' => 'function(data){$("#IndikatorEselonEmpat_idpejabat_eselon_empat").html(data);}'
        ))); ?>
...
<?php
    ...
    $opts3 = CHtml::listData(Pejabat::model()->findAll($criteria), 'id', 'fullName');
    echo $form->dropDownListControlGroup($model, 'idpejabat_eselon_empat', $opts3, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Tujuan--')); ?>
