...
<div class="form">
        ...
        echo $form->dropDownListControlGroup($model, 'id_instansi', $opts,
            array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih OPD--',
                'ajax' => array(
                    ...
                    'success' => 'function(data){$("#Indikatorkegiatan_nomor_misi").html(data);$("#Indikatorkegiatan_nomor_tujuan").html("<option value=\'\'>--Pilih Tujuan--</option>");$("#Indikatorkegiatan_nomor_sasaran").html("<option value=\'\'>--Pilih Sasaran--</option>");$("#Indikatorkegiatan_nomor_indikator").html("<option value=\'\'>--Pilih Indikator--</option>");$("#Indikatorkegiatan_nomor_program").html("<option value=\'\'>--Pilih Program--</option>");$("#Indikatorkegiatan_nomor_kegiatan").html("<option value=\'\'>--Pilih Kegiatan--</option>");}'
                )
            ));
    } else {
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_misi', $opts2, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Misi--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#Indikatorkegiatan_id_instansi").val()', 'NoMisi' => 'js: $(this).val()'),
            'success' => 'function(data){$("#Indikatorkegiatan_nomor_tujuan").html(data);$("#Indikatorkegiatan_nomor_sasaran").html("<option value=\'\'>--Pilih Sasaran--</option>");$("#Indikatorkegiatan_nomor_indikator").html("<option value=\'\'>--Pilih Indikator--</option>");$("#Indikatorkegiatan_nomor_program").html("<option value=\'\'>--Pilih Program--</option>");$("#Indikatorkegiatan_nomor_kegiatan").html("<option value=\'\'>--Pilih Kegiatan--</option>");}'
        ))); ?>
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_tujuan', $opts3, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Tujuan--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#Indikatorkegiatan_id_instansi").val()', 'NoMisi' => 'js: $("#Indikatorkegiatan_nomor_misi").val()', 'NoTujuan' => 'js: $(this).val()'),
            'success' => 'function(data){$("#Indikatorkegiatan_nomor_sasaran").html(data);$("#Indikatorkegiatan_nomor_indikator").html("<option value=\'\'>--Pilih Indikator--</option>");$("#Indikatorkegiatan_nomor_program").html("<option value=\'\'>--Pilih Program--</option>");$("#Indikatorkegiatan_nomor_kegiatan").html("<option value=\'\'>--Pilih Kegiatan--</option>");}'
        ))); ?>
    <?php
   /* $criteria = new CDbCriteria();
    $criteria->addCondition("id_instansi=:idx");
    ...
    echo $form->dropDownListControlGroup($model, 'indikator_tujuan', $opts5, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Indikator--',
        'ajax' => array(
            'type' => 'POST', //request type
            'url' => CController::createUrl('loaddata/loadsasaran'),
            'data' => array('OPD' => 'js: $("#Indikatorkegiatan_id_instansi").val()', 'NoMisi' => 'js: $("#Indikatorkegiatan_nomor_misi").val()', 'NoTujuan' => 'js: $("#Indikatorkegiatan_nomor_tujuan").val()', 'NoSasaran' => 'js: $("#Indikatorkegiatan_nomor_sasaran").val()', 'NoIndikator' => 'js: $(this).val()'),
            'success' => 'function(data){$("#Indikatorkegiatan_nomor_program").html(data);$("#Indikatorkegiatan_nomor_kegiatan").html("<option value=\'\'>--Pilih Kegiatan--</option>");}'
        )));*/ ?>
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_sasaran', $opts4, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Sasaran--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#Indikatorkegiatan_id_instansi").val()', 'NoMisi' => 'js: $("#Indikatorkegiatan_nomor_misi").val()', 'NoTujuan' => 'js: $("#Indikatorkegiatan_nomor_tujuan").val()', 'NoSasaran' => 'js: $(this).val()'),
            'success' => 'function(data){$("#Indikatorkegiatan_indikator_sasaran").html(data);$("#Indikatorkegiatan_nomor_program").html("<option value=\'\'>--Pilih Program--</option>");$("#Indikatorkegiatan_nomor_kegiatan").html("<option value=\'\'>--Pilih Kegiatan--</option>");}'
        ))); ?>
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_program', $opts6, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Program--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#Indikatorkegiatan_id_instansi").val()', 'NoMisi' => 'js: $("#Indikatorkegiatan_nomor_misi").val()', 'NoTujuan' => 'js: $("#Indikatorkegiatan_nomor_tujuan").val()', 'NoSasaran' => 'js: $("#Indikatorkegiatan_nomor_sasaran").val()', 'NoIndikator' => 'js: $("#Indikatorkegiatan_indikator_sasaran").val()', 'NoProgram' => 'js: $(this).val()'),
            'success' => 'function(data){$("#Indikatorkegiatan_nomor_kegiatan").html(data);}'
        ))); ?>
    ...
    echo $form->dropDownListControlGroup($model, 'indikator_program', $opts4, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih indikator--',
        'ajax' => array(
            ...
            'url' => CController::createUrl('loaddata/loadindikator'),
            'data' => array('OPD' => 'js: $("#Indikatorkegiatan_id_instansi").val()', 'NoMisi' => 'js: $("#Indikatorkegiatan_nomor_misi").val()', 'NoTujuan' => 'js: $("#Indikatorkegiatan_nomor_tujuan").val()', 'NoSasaran' => 'js: $(this).val()'),
            'success' => 'function(data){$("#Indikatorkegiatan_nomor_indikator").html(data);$("#Indikatorkegiatan_nomor_program").html("<option value=\'\'>--Pilih Program--</option>");$("#Indikatorkegiatan_nomor_kegiatan").html("<option value=\'\'>--Pilih Kegiatan--</option>");}'
        )));*/ ?>
