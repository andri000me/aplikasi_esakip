...
<div class="form">
        ...
        echo $form->dropDownListControlGroup($model, 'id_instansi', $opts,
            array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih OPD--',
                'ajax' => array(
                    ...
                    'success' => 'function(data){$("#Kegiatan_nomor_misi").html(data);$("#Kegiatan_nomor_tujuan").html("<option value=\'\'>--Pilih Tujuan--</option>");$("#Kegiatan_nomor_sasaran").html("<option value=\'\'>--Pilih Sasaran--</option>");$("#Kegiatan_nomor_indikator").html("<option value=\'\'>--Pilih Indikator--</option>");$("#Kegiatan_nomor_program").html("<option value=\'\'>--Pilih Program--</option>");}'
                )
            ));
    } else {
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_misi', $opts2, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Misi--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#Kegiatan_id_instansi").val()', 'NoMisi' => 'js: $(this).val()'),
            'success' => 'function(data){$("#Kegiatan_nomor_tujuan").html(data);$("#Kegiatan_nomor_sasaran").html("<option value=\'\'>--Pilih Sasaran--</option>");$("#Kegiatan_nomor_indikator").html("<option value=\'\'>--Pilih Indikator--</option>");$("#Kegiatan_nomor_program").html("<option value=\'\'>--Pilih Program--</option>");}'
        ))); ?>
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_tujuan', $opts3, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Tujuan--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#Kegiatan_id_instansi").val()', 'NoMisi' => 'js: $("#Kegiatan_nomor_misi").val()', 'NoTujuan' => 'js: $(this).val()'),
            'success' => 'function(data){$("#Kegiatan_nomor_sasaran").html(data);$("#Kegiatan_nomor_indikator").html("<option value=\'\'>--Pilih Indikator--</option>");$("#Kegiatan_nomor_program").html("<option value=\'\'>--Pilih Program--</option>");}'
        ))); ?>
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_sasaran', $opts4, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Sasaran--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#Kegiatan_id_instansi").val()', 'NoMisi' => 'js: $("#Kegiatan_nomor_misi").val()', 'NoTujuan' => 'js: $("#Kegiatan_nomor_tujuan").val()', 'NoSasaran' => 'js: $(this).val()'),
            'success' => 'function(data){$("#Kegiatan_nomor_indikator").html(data);$("#Kegiatan_nomor_program").html("<option value=\'\'>--Pilih Program--</option>");}'
        ))); ?>
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_indikator', $opts5, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Indikator--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#Kegiatan_id_instansi").val()', 'NoMisi' => 'js: $("#Kegiatan_nomor_misi").val()', 'NoTujuan' => 'js: $("#Kegiatan_nomor_tujuan").val()', 'NoSasaran' => 'js: $("#Kegiatan_nomor_sasaran").val()', 'NoIndikator' => 'js: $(this).val()'),
            'success' => 'function(data){$("#Kegiatan_nomor_program").html(data);}'
        ))); ?>
