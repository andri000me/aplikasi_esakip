...
$this->menu = array(
    ...
    array('label' => 'Update Kegiatan', 'url' => array('update', 'id' => $model->kegiatanid)),
    array('label' => 'Hapus Kegiatan', 'url' => '#', 'linkOptions' => array('submit' => array('delete', 'id' => $model->kegiatanid), 'confirm' => 'Anda yakin menghapus data ini ?')),
);
?>
