...
<div class="form">
    ...
    ?>
    <?php echo $form->textFieldControlGroup($model, 'nama_program', array('span' => 5, 'maxlength' => 255)); ?>
    <?php echo $form->textFieldControlGroup($model, 'pagu_anggaran', array('span' => 5, 'maxlength' => 255)); ?>
    <?php echo $form->textFieldControlGroup($model, 'sumber_dana', array('span' => 5, 'maxlength' => 100)); ?>
