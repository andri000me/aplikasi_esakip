...
<div class="form">
    ...
    <p class="help-block">Isian yang bertanda <span class="required">*</span> harus diisi.</p>
        ...
        echo $form->dropDownListControlGroup($model, 'id_instansi', $opts,
            array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih OPD--',
                'ajax' => array(
                    ...
                    'success' => 'function(data){$("#IndikatorProgramEselonTiga_nomor_misi").html(data);$("#IndikatorProgramEselonTiga_nomor_tujuan").html("<option value=\'\'>--Pilih Tujuan--</option>");$("#IndikatorProgramEselonTiga_nomor_sasaran").html("<option value=\'\'>--Pilih Sasaran--</option>");}'
                )
            ));
    } else {
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_misi', $opts2, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Misi--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#IndikatorProgramEselonTiga_id_instansi").val()', 'NoMisi' => 'js: $(this).val()'),
            'success' => 'function(data){$("#IndikatorProgramEselonTiga_nomor_tujuan").html(data);$("#IndikatorProgramEselonTiga_nomor_sasaran").html("<option value=\'\'>--Pilih Sasaran--</option>");}'
        ))); ?>
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_tujuan', $opts3, array('span' => 5, 'maxlength' => 7, 'prompt' => '--Pilih Tujuan--',
        'ajax' => array(
            ...
            'data' => array('OPD' => 'js: $("#IndikatorProgramEselonTiga_id_instansi").val()', 'NoMisi' => 'js: $("#IndikatorProgramEselonTiga_nomor_misi").val()', 'NoTujuan' => 'js: $(this).val()'),
            'success' => 'function(data){$("#IndikatorProgramEselonTiga_nomor_sasaran").html(data);}'
        ))); ?>
    ...
    echo $form->dropDownListControlGroup($model, 'nomor_sasaran', $opts4, array('span' => 5, 
    'maxlength' => 7, 'prompt' => '--Pilih Sasaran--',
        'ajax' => array(
            'type' => 'POST', //request type
            'url' => CController::createUrl('loaddata/loadjabataneselontiga'),
            'data' => array('OPD' => 'js: $("#IndikatorProgramEselonTiga_id_instansi").val()', 'NoMisi' => 'js: $("#IndikatorProgramEselonTiga_nomor_misi").val()', 'NoTujuan' => 'js: $("#IndikatorProgramEselonTiga_nomor_tujuan").val()', 'NoSasaran' => 'js: $(this).val()'),
            'success' => 'function(data){$("#IndikatorProgramEselonTiga_idpejabat_eselon_tiga").html(data);}'
        ))); ?>
    ...
    $opts4 = CHtml::listData(Pejabat::model()->findAll($criteria), 'id', 'fullName');
    echo $form->dropDownListControlGroup($model, 'idpejabat_eselon_tiga', $opts4, array('span' => 5, 
    'maxlength' => 7, 'prompt' => '--Pilih Jabatan Eselon Tiga--',
        'ajax' => array(
            'type' => 'POST', //request type
            'url' => CController::createUrl('loaddata/loadprogrameselontiga'),
            'data' => array('OPD' => 'js: $("#IndikatorProgramEselonTiga_id_instansi").val()', 'NoMisi' => 'js: $("#IndikatorProgramEselonTiga_nomor_misi").val()', 'NoTujuan' => 'js: $("#IndikatorProgramEselonTiga_nomor_tujuan").val()', 'NoSasaran' => 'js: $("#IndikatorProgramEselonTiga_nomor_sasaran").val()'),
            'success' => 'function(data){$("#IndikatorProgramEselonTiga_nomor_program").html(data);}'
    ))); ?>
...
<?php
    ...
    $opts4 = CHtml::listData(ProgramEselonTiga::model()->findAll($criteria), 'nomor_program', 'fullName');
    echo $form->dropDownListControlGroup($model, 'nomor_program', $opts4, array('span' => 5, 
    'maxlength' => 7, 'prompt' => '--Pilih Program--',
        'ajax' => array(
            'type' => 'POST', //request type
            'url' => CController::createUrl('loaddata/loadjabataneselonempat'),
            'data' => array('OPD' => 'js: $("#IndikatorProgramEselonTiga_id_instansi").val()', 'idpejabat_eselon_tiga' => 'js: $("#IndikatorProgramEselonTiga_idpejabat_eselon_tiga").val()'),
            'success' => 'function(data){$("#IndikatorProgramEselonTiga_idpejabat_eselon_empat").html(data);}'
    ))); ?>
...
<?php
    ...
    $opts4 = CHtml::listData(Pejabat::model()->findAll($criteria), 'id', 'fullName');
    echo $form->dropDownListControlGroup($model, 'idpejabat_eselon_empat', $opts4, array('span' => 5, 
    'maxlength' => 7, 'prompt' => '--Pilih Jabatan--')); ?>
