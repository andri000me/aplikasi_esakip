...
<div class="top-bar clearfix">
    ...
    <div class="pull-right" id="mini-nav-right">
		...
		<a href="<?php echo Yii::app()->baseUrl; ?>/indikatorprogram/eselonTiga" class="btn btn-info btn-xs" rel="tooltip"
           data-original-title="Daftar Indikator Program Eselon 3">
		   Eselon 3
        </a>
		
		<a href="<?php echo Yii::app()->baseUrl; ?>/indikatorprogram/create" class="btn btn-info btn-xs" rel="tooltip"
