...
<div class="top-bar clearfix">
    ...
    <div class="pull-right" id="mini-nav-right">
        <a href="<?php echo Yii::app()->baseUrl; ?>/renstra/create" class="btn btn-info btn-xs" rel="tooltip"
...
<div class="container-fluid">
    ...
    <div class="spacer-xs">
        ...
        $coul = array(
            ...
            array(
                'header' => 'File Renstra',
                'name' => 'data_file_renstra',
                'type' => 'raw',
                'value' => 'CHtml::link($data->data_file_renstra,
                        Yii::app()->createUrl("static/datarenstra/$data->data_file_renstra"),
                        array("target"=>"_blank") )',
            ),
