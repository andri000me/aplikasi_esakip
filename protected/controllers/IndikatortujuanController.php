...
class IndikatortujuanController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if (isset($_POST['Indikatortujuan'])) {
			$model->attributes=$_POST['Indikatortujuan'];
			if ($model->save()) {
	...
	public function actionDelete($id)
	{
		if (Yii::app()->request->isPostRequest) {
            ...
            $model = $this->loadModel($id);
            $dataanak = Sasaran::model()->findAllByAttributes(
	...
	{
        $model=new Indikatortujuan('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Indikatortujuan'])) {
        $model->attributes=$_GET['Indikatortujuan'];
        }
	...
	{
		$model=Indikatortujuan::model()->findByPk($id);
		if ($model===null) {
	...
	{
		if (isset($_POST['ajax']) && $_POST['ajax']==='indikatortujuan-form') {
