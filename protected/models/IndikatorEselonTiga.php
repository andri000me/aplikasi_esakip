 ...
 */
class IndikatorEselonTiga extends RActiveRecord
{
    /**
	...
	public function rules()
	{
		...
		return array(
			array('id_instansi, nomor_misi, nomor_sasaran_eselon_tiga, nomor_indikator, idpejabat_eselon_tiga', 'required'),
			array('nomor_misi, nomor_tujuan, nomor_sasaran_eselon_tiga, nomor_indikator, indikator_kinerja_utama, tipe_formula, indikator_pk', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			...
			'nomor_sasaran_eselon_tiga' => 'No. Sasaran Eselon Tiga',
			'nomor_indikator' => 'No. Indikator Eselon Tiga',
			'indikator' => 'Indikator Eselon Tiga',
			'satuan' => 'Satuan',
