 ...
 */
class Indikatortujuan extends RActiveRecord
{
    /**
	...
	public function rules()
	{
		...
		return array(
			array('id_instansi, nomor_tujuan,nomor_misi', 'required'),
            ...
            array('target_rpjm1, target_rpjm2, target_rpjm3, target_rpjm4, target_rpjm5, target_tahun_sebelumnya, realisasi_tahun_sebelumnya, target, realisasi, target_triwulan1, target_triwulan2, target_triwulan3, target_triwulan4, realisasi_triwulan1, realisasi_triwulan2, realisasi_triwulan3, realisasi_triwulan4', 'numerical', 'integerOnly'=>false),
            array('target_rpjm1, target_rpjm2, target_rpjm3, target_rpjm4, target_rpjm5, target_tahun_sebelumnya, realisasi_tahun_sebelumnya, target, realisasi, target_triwulan1, target_triwulan2, target_triwulan3, target_triwulan4, realisasi_triwulan1, realisasi_triwulan2, realisasi_triwulan3, realisasi_triwulan4', 'default', 'setOnEmpty' => true, 'value' => 0),
	...
	public function search()
	{
		...
		return new CActiveDataProvider($this, array(
			'criteria'=>$criteria,
            'sort'=>array(
                'defaultOrder'=>'id_instansi,nomor_misi,nomor_tujuan,nomor_indikator',
                'multiSort'=>true,
            ),
		));
	}
