 ...
 * @property string $cdt
 */
class SasaranEselonTiga extends RActiveRecord
{
    /**
	...
	public function attributeLabels()
	{
		return array(
			...
			'datapejabat.nama_jabatan' => 'Nama Jabatan Eselon Tiga',
			'idpejabat' => 'ID Jabatan Eselon Tiga',
			'nomor_sasaran' => 'Nomor Sasaran Eselon Tiga',
			'nomor_sasaran_eselon_dua' => 'Nomor Sasaran Eselon Dua'
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nomor_sasaran',$this->nomor_sasaran);
		$criteria->compare('idpejabat',$this->idpejabat);
		$criteria->compare('nomor_sasaran_eselon_dua',$this->nomor_sasaran_eselon_dua);
