 ...
 * @property string $cdt
 */
class FileCascading extends RActiveRecord
{
    /**
	...
	public function rules()
	{
		...
		return array(
			...
			array('file_cas', 'length', 'max'=>150),
            array('file_cas', 'file', 'types' => 'jpg, png, pdf, doc, docx, xlsx, xls', 'allowEmpty' => false, 'maxSize' => 1024 * 1024 * 50, 'tooLarge' => 'file lebih dari 50MB. Please upload file yang lebih kecil.'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_instansi, file_cas', 'safe', 'on'=>'search'),
			array('file_cas', 'safe', 'on'=>'create'),
    ...
    {
        return $this->file_cas.'. '.$this->nama_instansi;
    }
	...
	public function search()
	{
		...
		$criteria->compare('file_cas',$this->file_cas,true);
	...
	// 	$criteria->compare('file_cas',$this->file_cas);

	// 	return new CActiveDataProvider($this, array(
	// 		'criteria'=>$criteria,
    //         'sort'=>array(
    //             'defaultOrder'=>'id,id_instansi,file_cas, update_time',
    //             'multiSort'=>true,
    //         ),
	// 	));
	// }
