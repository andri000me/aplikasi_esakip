 ...
 */
class IndikatorEselonEmpat extends RActiveRecord
{
    /**
	...
	{
		return 'tindikator_eselon_empat';
	}
	...
	public function rules()
	{
		...
		return array(
			array('id_instansi, nomor_misi, nomor_indikator, nomor_sasaran_eselon_empat, idpejabat_eselon_tiga, idpejabat_eselon_empat', 'required'),
			array('nomor_misi, nomor_tujuan, nomor_indikator, indikator_kinerja_utama, tipe_formula, indikator_pk', 'numerical', 'integerOnly'=>true),
	...
	public function relations()
	{
		...
		return array(
            ...
            'datasasaraneselonempat' => array(self::BELONGS_TO, 'Sasaraneselonempat', '','foreignKey' => array('id_instansi'=>'id_instansi',
                'nomor_misi'=>'nomor_misi',
                'nomor_tujuan'=>'nomor_tujuan',
				'nomor_sasaran_eselon_empat'=>'nomor_sasaran')
		),
		'datapejabateselontiga' => array(self::BELONGS_TO, 'Pejabat', '','foreignKey' => array('idpejabat_eselon_tiga'=>'id')),
		'datapejabateselonempat' => array(self::BELONGS_TO, 'Pejabat', '','foreignKey' => array('idpejabat_eselon_empat'=>'id')),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'nomor_indikator' => 'No. Indikator Eselon Empat',
			'indikator' => 'Indikator Eselon Empat',
			'satuan' => 'Satuan',
			...
			'nomor_sasaran_eselon_empat' => 'No. Sasaran Eselon Empat',
			'idpejabat_eselon_empat' => 'Nama Jabatan Eselon Empat',
			'idpejabat_eselon_tiga' => 'Nama Jabatan Eselon TIga',
			'datapejabateselontiga.nama_jabatan' => 'Nama Jabatan Eselon Tiga',
			'datapejabateselonempat.nama_jabatan' => 'Nama Jabatan Eselon Empat',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('idpejabat_eselon_tiga',$this->idpejabat_eselon_tiga);
		$criteria->compare('idpejabat_eselon_empat',$this->idpejabat_eselon_empat);
		$criteria->compare('nomor_tujuan',$this->nomor_tujuan);
		$criteria->compare('nomor_sasaran_eselon_empat',$this->nomor_sasaran_eselon_empat);
