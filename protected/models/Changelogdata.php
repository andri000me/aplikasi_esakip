 ...
 */
class Changelogdata extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('txtlog, cdt', 'required'),
			array('cuser', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('tid, txtlog, cdt, cuser', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('txtlog',$this->txtlog,true);
	 ...
	 * @return changelogdata the static model class
	 */
