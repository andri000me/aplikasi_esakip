...
/**
 * This is the model class for table "tindikator_program".
 *
 * The followings are the available columns in table 'tindikator_program':
 ...
 */
class IndikatorProgramEselonTiga extends RActiveRecord
{
	...
	{
		return 'tindikator_program_eselon_tiga';
	}
	...
	public function rules()
	{
		...
		return array(
			array('id_instansi, nomor_misi, nomor_tujuan, nomor_sasaran, nomor_program, nomor_indikator, idpejabat_eselon_tiga, idpejabat_eselon_empat', 'required'),
			array('nomor_misi, nomor_tujuan, nomor_sasaran, nomor_program, nomor_indikator, indikator_kinerja_utama, tipe_formula, indikator_pk', 'numerical', 'integerOnly'=>true),
	...
	public function search()
	{
		...
		$criteria->compare('indikator_sasaran',$this->indikator_sasaran);
	 ...
	 * @return IndikatorProgram the static model class
	 */
