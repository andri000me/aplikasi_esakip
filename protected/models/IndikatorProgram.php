 ...
 */
class IndikatorProgram extends RActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_instansi, nomor_misi, nomor_tujuan, nomor_sasaran, nomor_program, nomor_indikator', 'required'),
