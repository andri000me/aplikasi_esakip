 ...
 * @property string $cdt
 */
class SasaranEselonEmpat extends RActiveRecord
{
    /**
	...
	public function rules()
	{
		...
		return array(
			array('id_instansi, nomor_misi, nomor_tujuan, sasaran,capaian_sasaran, parentid, nomor_sasaran, nomor_sasaran_eselon_dua, nomor_sasaran_eselon_tiga, idpejabat_eselon_tiga, idpejabat_eselon_empat', 'required'),
			...
			array('sasaranid, id_instansi, nomor_misi, nomor_tujuan, nomor_sasaran, sasaran, sasaran_strategis, capaian_sasaran, cdt', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
        ...
        return array(
			...
			'datasasaraneselontiga' => array(self::BELONGS_TO, 'SasaranEselonTiga', '','foreignKey' => array('id_instansi'=>'id_instansi',
																												'nomor_misi'=>'nomor_misi',
																												'nomor_tujuan'=>'nomor_tujuan',
																												'nomor_sasaran_eselon_tiga'=>'nomor_sasaran')),
	...
	public function attributeLabels()
	{
		return array(
			...
			'sasaran' => 'Sasaran Eselon Empat',
			'sasaran_strategis' => 'Sasaran Strategis',
			'capaian_sasaran' => 'Capaian Sasaran',
			'cdt' => 'Recorded',
			'parentid' => 'Sasaran Eselon Tiga',
			'datasasaraneselonempat.sasaran' => 'Sasaran Eselon Tiga II',
			'nama_jabatan' => 'Nama Jabatan Eselon Tiga',
			'datasasaran.sasaran' => 'Sasaran Eselon Dua',
			'idpejabat_eselon_tiga' => 'ID Jabatan Eselon Tiga',
			'idpejabat_eselon_empat' => 'ID Jabatan Eselon Empat',
			'datasasaraneselontiga.sasaran' => 'Sasaran Eselon Tiga',
	...
	public function search()
	{
		...
		$criteria->compare('nomor_tujuan',$this->nomor_tujuan);
		$criteria->compare('nomor_sasaran',$this->nomor_sasaran);
		$criteria->compare('nomor_sasaran_eselon_tiga',$this->nomor_sasaran_eselon_tiga);
